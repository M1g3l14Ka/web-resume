                        ...
                        <div className="flex flex-wrap justify-center items-center gap-3 w-auto mt-6">
                            {headerTitleBtns.map((btn: IHeaderTitleBtns) => (
                                <Link href={`#${btn.id}`} key={btn.id}>
                                    <div className="flex justify-center items-center rounded-2xl border w-28 md:w-32 h-8 hover:bg-linear-120 from-orange-400 to-rose-600 transition ease-in-out duration-300 bg-[#131212] hover:scale-110 cursor-pointer hover:border-none">
